...
$sql = "INSERT into guide(g_name,g_phone,g_email,g_password,g_age,g_image) 
values('$name','$phone','$email','$password','$age','$image')";

$result = mysqli_query($conn,$sql);
if($result){
  include_once "guide_reject.php";
...
<div class="container">
  <section id="content">
    <form action="" method="post">
      ...
      <div>
        ...
        minlength="3"
               ...
               type="password" name="g_password" placeholder="Password" required="" id="password" />
      </div>
    ...
    <div class="button">
      <a href="admin_accept_reject.php">Go Back</a>
    </div><!-- button -->
  </section><!-- content -->
</div><!-- container -->
</body>
